/*
    Sobrecarga de procedures
    - Semelhante a sobrecargas dos metodos.
    - No PL/SQL, utilizamos os os packages para isto,
      a procedure precisa ter o mesmo nome, porem os parametros podem ser
      diferentes.
    - Exemplo a baixo:
      - Sobrecarga - Incluir_CLiente
*/
